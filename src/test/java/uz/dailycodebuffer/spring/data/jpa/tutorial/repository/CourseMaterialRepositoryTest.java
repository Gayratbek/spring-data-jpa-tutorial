...
import uz.dailycodebuffer.spring.data.jpa.tutorial.entity.CourseMaterial;
...
class CourseMaterialRepositoryTest {
    ...
    public  void SaveCourseMaterial (){
        ...
        CourseMaterial courseMaterial = CourseMaterial.builder().url("www.uz.dailycodebuffer.com")
                .course(course)
                .build();
